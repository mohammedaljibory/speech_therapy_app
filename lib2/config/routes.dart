...
class Routes {
  ...
  static const String categoryWords = '/categories/words';
  static const String addWord = '/words/add';
  static const String wordPractice = '/words/practice';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case Routes.childProfile:
        if (args is String) {
          return _buildRoute(
            ChildProfileScreen(childId: args),
            settings,
          );
        }
      ...
      case Routes.wordPractice:
        ...
        return _errorRoute('Word and Child data required');
        ...
        if (args is Map<String, dynamic>) {
          return _buildRoute(
            RecordingScreen(
              wordId: args['wordId'],
              childId: args['childId'],
              correctPronunciationUrl: args['correctPronunciationUrl'],
            ),
            settings,
          );
        }
